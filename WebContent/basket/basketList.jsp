...
<body>
	...
	<div class='wishlists-container'>
		<div class='wishlists-header-container'>
			...
			<div class='wishlists-header-subtitle'>
				<p class="np">
				<center>
					총
		...
		<div class='wishlists-cards-container'>
			...
			<div class='select-wrapper' align="center">
				...
				<table class="table" size="100%" align="center">
					...
					<tr>
						<td colspan=2>
							...
							<table class="table" size="50%" cellpadding="0" cellspacing="0">
								<tr height=26 bgcolor="#FFDDDD">
									...
									<th width="10%"><font size="2">국가</font></th>
									<th width="10%"><font size="2">지역</font></th>
							...
							<table class="table" size="50%" cellspacing="0" cellpadding="0">
								<tr>
									<td height="2" bgcolor="#FFDDDD"></td>
								</tr>
							</table>

							<form action="DeleteBasket.action" name="Bdel" method="post"
								onsubmit="return check()">
								<s:elseif test="bhlist.size()>0">
								...
								<table class="table" size="100%" align="center">
									...
									<tr>
										<td colspan=2>
											<p align="center">
												<input type="hidden" name="order" value="basket">
											<table class="table" size="50%" cellpadding="0"
												cellspacing="0">
												<tr height=26 bgcolor="#FFDDDD">
													<td align=left><input name="checkall" type="checkbox"
														onclick="javascript:CheckAll()"></td>
												...
												<s:if test="btlist.size()<=0">
													<tr align="center">
														<td colspan="6"><br> <img
															src="./images/wishlist_empty.jpg" width="40" height="40"><br>
														<br>위시리스트에 담긴 상품이 없습니다.<br>TMT와 즐거운 여행을 계획해보세요.
														</td>
													</tr>
												</s:if>
											...
											<table class="table" size="50%" cellspacing="0"
												cellpadding="0">
												<tr>
													<td height="2" bgcolor="#FFDDDD"></td>
												</tr>
									...
									<tr align="center">
										<td colspan="6"><s:property value="pagingHtml"
												escape="false" /></td>
									</tr>
