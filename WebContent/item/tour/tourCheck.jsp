     ...
     <center><b><font size="5" color="#1b5ac2">예약 하기</font></b></center>
        ...
        <div id="contents">
			<div id="coutents_left">
			   ...
			   <h4>[투어] <s:property value="%{name}"/></h4>
			   <s:property value="%{country}"/>-<s:property value="%{region}"/>			   
			   </div>
			   <hr>
			   <div id="coutents_left_1">
			       <font color="#e30413">선택한 상품과 수량을 다시한번 확인해주세요!<br>
			       잘못된 입력시 책임지지 않습니다.</font>		   
			   </div>
			   <hr>
			   <div id="coutents_left_1">
			       일반 패키지<br><br>
			       <s:property value="%{amount}"/> X ₩<s:property value="%{price}"/>   		   
			   </div>
			   ...
			   <div id="coutents_left_2">
			    ...
			    <div id="coutents_left_2_2">
			     <b><s:property value="%{amount*price}"/>원</font></b>	 
			     </div>
			     <br>
			   </div>
			</div>
