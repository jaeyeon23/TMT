...
<button type="submit"class="btn btn-default" align="right">편집</button>
 ...
 <tr>
  ...
  <td align="left" bgcolor="white"height="40"><strong>이름</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:property value="%{resultClassid}"/></td>
  </tr>
   <tr>
  <td align="left" bgcolor="white"height="40"><strong>이메일</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:property value="%{resultClassemail}"/></td>
  </tr>
   <tr>
  <td align="left" bgcolor="white" height="40"><strong>연락처</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:property value="%{resultClass.tel}"/></td>
  </tr>
   <tr>
  <td align="left" bgcolor="white" height="40"><strong>비밀번호</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:property value="%{resultClasspassword}"/></td>
  </tr>
   <tr>
