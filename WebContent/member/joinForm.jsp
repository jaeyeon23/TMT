								...
								<div class="col-xs-12">
									<div class="checkbox-signup-wrapper" id="signupCheckboxGroup">
										<div class="checkbox-signup form-group checkbox-custom checkbox-primary">
											<input name="marketing1" id="marketing1" type="checkbox" value="true" data-fv-field="checkbox_terms">
												...
												<div class="terms-text" data-title="회원가입 및 운영약관">
														<!--회원가입 및 운영약관<br>
 														<br>제 1 조 (목적)<br>이 약관은 주식회사 TMT(이하 "당사"이라
														합니다)이 운영하는 웹사이트(https://www.TMT.com) 및
													...
													<small class="help-block" style="display: none;"
														data-fv-validator="notEmpty" data-fv-for="checkbox_terms"
														data-fv-result="NOT_VALIDATED">약관 동의에 체크해 주세요.</small>
										</div>
										<div class="checkbox-signup form-group checkbox-custom checkbox-primary">
