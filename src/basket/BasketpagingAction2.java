...
public class BasketpagingAction2 {
	...
	public BasketpagingAction2(int currentPage, int currentPage2, int totalCount2, int blockCount2, int blockPage2) {
		...
		if (currentPage2 > blockPage2) {
			pagingHtml2.append("<a href=BasketList.action?currentPage=" + currentPage + "&currentPage2=" + (startPage2 - 1) + ">");
		...
		for (int i = startPage2; i <= endPage2; i++) {
			...
			if (i == currentPage2) {
				...
				pagingHtml2.append("&nbsp;<a href='BasketList.action?currentPage=");
				pagingHtml2.append(currentPage);
				pagingHtml2.append("&currentPage2=");
				pagingHtml2.append(i);
				pagingHtml2.append("'>");
				pagingHtml2.append(i);
				pagingHtml2.append("</a>");
		...
		if (totalPage2 - startPage2 >= blockPage2) {
			pagingHtml2.append("<a href=BasketList.action?currentPage=" + currentPage + "&currentPage2=" + (endPage2 + 1) + ">");
