...
public class OrderList extends ActionSupport implements SessionAware{
  ...
  public OrderList() throws IOException {
   ...
   public String execute() throws Exception {
      ...
      totalCount = otlist.size();
      page2 = new OrderpagingAction2(currentPage2,totalCount2,blockCount2,blockPage2);
      ...
      page3 = new OrderpagingAction3(currentPage3,totalCount3,blockCount3,blockPage3);
